...
int main(int argc, char *argv[]) {
    ...
    if (mpi_rank == MASTER) {
        ...
        if (output_file != NULL) {
            ...
            // CORRECCIÓN: Cambiado de output_output_file a output_file
            fprintf(output_file, "CONFIGURACION | HILOS/PROCESO | TOTAL HILOS | PI CALCULADO | ERROR ABSOLUTO | ERROR RELATIVO%% | TIEMPO(s) | SPEEDUP | EFICIENCIA\n");
            fprintf(output_file, "----------------------------------------------------------------------------------------------------------------------------\n");
        }
